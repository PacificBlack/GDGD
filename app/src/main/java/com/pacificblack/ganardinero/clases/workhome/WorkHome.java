package com.pacificblack.ganardinero.clases.workhome;
...
public class WorkHome implements Serializable {
    ...
    public WorkHome(String titulo, String des1, String des2, String des3, String des4, String des5, String fecha, String imagen1, String imagen2, String imagen3, String imagen4, String imagen5) {
        this.titulo = titulo;
        this.des1 = des1;
        this.des2 = des2;
        this.des3 = des3;
